...
code, because a code anybody can redeem is a code whoever finds it can redeem. It also keeps a
record of who redeemed it. **There is no creator**: authorization to issue
